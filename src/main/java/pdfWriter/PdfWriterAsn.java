...
public class PdfWriterAsn {
    ...
    public static void createAsnPdf(InvoiceDtlDTO invoiceDtlDTO, InvoiceDTO invoiceDTO) {
        try {
            ...
            PdfWriter pdfWriter = PdfWriter.getInstance(document, new FileOutputStream("E:/AAD/Documents/Daimler/CreatePdf/firstNew.pdf"));
            document.open();
            Font fontNormal = new Font(Font.FontFamily.TIMES_ROMAN, 10f, Font.BOLD, BaseColor.BLACK);
            Font fontBig = new Font(Font.FontFamily.TIMES_ROMAN, 11f, Font.BOLD, BaseColor.BLACK);
...
//            cell.setPaddingBottom(5f);
            ...
            /*Storage Location*/
            cell = insertCell(table, "MAC01D2-D2", Element.ALIGN_CENTER, Element.ALIGN_TOP, 3, 1, fontBig, null);
            cell.setBorder(Rectangle.LEFT | Rectangle.BOTTOM);
            table.addCell(cell);
            ...
            cell = insertCell(table, "SHIP FROM", Element.ALIGN_LEFT, Element.ALIGN_TOP, 3, 1, fontBig, null);
            cell.setBorder(Rectangle.LEFT | Rectangle.RIGHT);
            table.addCell(cell);

            cell = insertCell(table, "SHIP TO", Element.ALIGN_LEFT, Element.ALIGN_TOP, 5, 1, fontBig, null);
            cell.setBorder(Rectangle.LEFT | Rectangle.RIGHT);
            table.addCell(cell);
            ...
            cell = insertCell(table, " M.D.INDUSTRIES\n" +
                    "H-28 MIDC AMBAD,,NASIK-422010,India", Element.ALIGN_LEFT, Element.ALIGN_TOP, 3, 3, fontBig, null);
            cell.setBorder(Rectangle.LEFT | Rectangle.BOTTOM);
            ...
            cell = insertCell(table, "Daimler India Com.Vehicles Pvt.Ltd.\n" +
                    " Oragadam,Sriperumbudur - 602105, India", Element.ALIGN_LEFT, Element.ALIGN_TOP, 5, 3, fontBig, null);
            cell.setBorder(Rectangle.LEFT | Rectangle.BOTTOM);
            cell.setPaddingBottom(10f);
            table.addCell(cell);
